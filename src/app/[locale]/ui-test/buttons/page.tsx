...
import {
  Star, Settings, AlertTriangle, CheckCircle, XCircle, Info, AlertCircle,
} from "lucide-react"
    ...
    <div className="flex flex-col gap-16">
      ...
      <section className="flex flex-col gap-10">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-wrap gap-4">
            <ButtonGroup variant="outline">
              <Button variant="outline" size="icon"><AlertCircle /></Button>
              <Button variant="outline" size="icon"><Info /></Button>
              <Button variant="outline" size="icon"><CheckCircle /></Button>
            </ButtonGroup>
            <ButtonGroup>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-3">
            {(["default", "secondary", "success", "destructive", "warning", "info", "dark"] as const).map(v => (
