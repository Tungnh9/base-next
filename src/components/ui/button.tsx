  ...
  "inline-flex shrink-0 cursor-pointer items-center justify-center gap-2 font-medium whitespace-nowrap tracking-[0.43px] transition-all duration-150 outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:cursor-not-allowed disabled:opacity-65 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        info: "bg-info text-white shadow-[0px_2px_4px_rgba(165,163,174,0.3)] enabled:hover:brightness-90 enabled:active:brightness-[0.85] focus-visible:ring-info/20 dark:focus-visible:ring-info/40 disabled:shadow-none dark:shadow-none",
        dark: "bg-dark text-dark-foreground shadow-[0px_2px_4px_rgba(165,163,174,0.3)] enabled:hover:brightness-90 enabled:active:brightness-[0.85] focus-visible:ring-dark/20 disabled:shadow-none dark:shadow-none",
        outline:
      ...
      size: {
        ...
        sm: "h-7 gap-1.5 rounded-[4px] px-[14px] text-[13px] has-[>svg]:px-[10px] [&_svg:not([class*='size-'])]:size-[14px]",
        // Figma Large: h=48px, px=26px, font=17px, radius=8px
        lg: "h-12 rounded-[8px] px-[26px] text-[17px] has-[>svg]:px-5 [&_svg:not([class*='size-'])]:size-[18px]",
        // Icon sizes match text button heights
        icon: "size-[38px] rounded-[6px] [&_svg:not([class*='size-'])]:size-[18px]",
        "icon-xs": "size-6 rounded-[4px] [&_svg:not([class*='size-'])]:size-3",
        "icon-sm": "size-7 rounded-[4px] [&_svg:not([class*='size-'])]:size-[14px]",
        "icon-lg": "size-12 rounded-[8px] [&_svg:not([class*='size-'])]:size-[22px]",
      },
    },
    compoundVariants: [
      // ── outline skin ─────────────────────────────────────────────────────────
